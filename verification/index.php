...
<head>
    ...
    <title> Waterlab Water Testing Laboratory Inc.</title>
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-12 left-item">
                        <ul>
                            <li><i class="fas fa-envelope-square"></i> sales@waterlablaboratory.com</li>
                            <li><i class="fas fa-phone-square"></i> 02 8294-2345</li>
                        </ul>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 map-img">
                    ...
                    <address class="md-margin-bottom-40">
                        Waterlab <br>
                        137 Quirino Hiway Baesa <br>
                        Quezon City, Philippines <br>
                        Phone: 02 294-2345 <br>
                        Email: <a href="mailto:info@anybiz.com" class="">caloocanwaterlab@yahoo.com</a><br>
                        Web: <a href="smart-eye.html" class="">www.waterlablaboratory.com</a>
                    </address>
    ...
    <div class="copy">
            <div class="container">
                <a href="https://www.smarteyeapps.com/">2009 &copy; All Rights Reserved | Designed and Developed by OgieCastro</a>
